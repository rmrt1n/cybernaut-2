...
<div class="h-screen pb-14 bg-right bg-cover" style="background-image:url('bg.svg');">
  ...
  <div class="container px-6 mx-auto flex flex-wrap flex-col md:flex-row items-center">
    ...
    <div class="flex flex-col w-full xl:w-2/5 justify-center lg:items-start overflow-y-hidden">
      ...
      >
        All-in-one Cybersecurity Awareness App
      </h1>
      <p
      ...
      <a href="/signin" class="btn btn-primary fade-in">Try it out</a>
      <div class="flex w-full justify-center md:justify-start pb-24 lg:pb-0 fade-in" />
    </div>

    <!--Right Col-->
    <div class="w-full xl:w-3/5 py-6 overflow-y-hidden">
      <img class="w-5/6 mx-auto lg:mr-0 slide-in-bottom" src="/email.jpg" />
    </div>

    <!--Footer-->
    <div class="w-full pt-16 pb-6 text-sm text-center md:text-left fade-in">
      <a class="text-gray-500 no-underline hover:no-underline" href="#">&copy; Sotong 2019</a>
    </div>
  </div>
</div>
